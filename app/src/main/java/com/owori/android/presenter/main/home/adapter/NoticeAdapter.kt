...
class NoticeAdapter(private val clickEvent: (id: Int) -> Unit = {}) :
    ListAdapter<NoticeData, NoticeAdapterViewHolder>(
        noticeDiffUtil
    ) {
    ...
    companion object {
        private val noticeDiffUtil = object : DiffUtil.ItemCallback<NoticeData>() {
